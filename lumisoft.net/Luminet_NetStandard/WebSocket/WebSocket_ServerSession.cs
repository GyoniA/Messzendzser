...
namespace LumiSoft.Net.WebSoclet
{
    public class WebSocket_ServerSession : TCP_Session
    {
        ...
        /// Default constructor.
        /// </summary>
        public WebSocket_ServerSession()
        {
        ...
        internal void StartI()
        {
            if (true)//m_IsSsl == SslMode.SSL)
            {
                ...
                op.CompletedAsync += delegate (object sender, EventArgs<WebSocket_ServerSession.SwitchToSecureAsyncOP> e) {
        ...
        public class SwitchToSecureAsyncOP : IDisposable, IAsyncOP
        {
            ...
            private WebSocket_ServerSession m_pTcpSession = null;
            ...
            internal bool Start(WebSocket_ServerSession owner)
            {
                if (owner == null)
                {
